function action_toggle_class(e) {
  var t = e.target_id,
    n = e.class_name,
    r = e.body_class_name || "";
  $("#" + t).toggleClass(n), "" != r && $("body").toggleClass(r);
}
!(function (e, t) {
  "use strict";
          ...
          (v = k(
            ...
            (c = function (e, t, n, a, c) {
              ...
              if (((m += y), s && y !== m)) {
                ...
                if (e) {
                  if (0 < m) for (; y--; ) x[y] || b[y] || (b[y] = q.call(a));
                  b = Te(b);
                }
                H.apply(a, b),
                  c &&
  ...
  function xe(e, t, n, r, i) {
    ...
    for (f.textContent = "", d = 0; (o = p[d++]); )
      if (r && -1 < w.inArray(o, r)) i && i.push(o);
        ...
        ((l = ie(o)), (a = ve(f.appendChild(o), "script")), l && me(a), n)
      )
  ...
  function He(e, t, n, r) {
    ...
    var i,
      ...
      v = t[0],
      m = h(v);
    if (m || (1 < p && "string" == typeof v && !d.checkClone && Ae.test(v)))
          ...
          (l = s[f]),
            he.test(l.type || "") &&
              ...
              (l.src && "module" !== (l.type || "").toLowerCase()
                ...
                : y(l.textContent.replace(Ne, ""), l, c));
    }
    return e;
  }
  function Oe(e, t, n) {
    for (var r, i = t ? w.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
      n || 1 !== r.nodeType || w.cleanData(ve(r)),
        r.parentNode &&
          (n && ie(r) && me(ve(r, "script")), r.parentNode.removeChild(r));
    return e;
  }
  w.extend({
    ...
    clone: function (e, t, n) {
      ...
      return (
        0 < (a = ve(c, "script")).length && me(a, !f && ve(e, "script")), c
      );
    },
    ...
    style: function (e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var i,
          ...
          l = e.style;
        if (
          (u || (t = ze(s)), (a = w.cssHooks[t] || w.cssHooks[s]), void 0 === n)
        )
    ...
    trigger: function (t, n, r, i) {
      ...
      if (
        ...
        3 !== r.nodeType &&
          ...
          ((t = t[w.expando]
            ? t
            : new w.Event(y, "object" == typeof t && t)).isTrigger = i ? 2 : 3),
          (t.namespace = x.join(".")),
        ...
        if (!i && !p.noBubble && !g(r)) {
          for (
            u = p.delegateType || y, yt.test(u + y) || (a = a.parentNode);
            a;
            a = a.parentNode
          )
            m.push(a), (s = a);
      ...
      ajax: function (t, n) {
        ...
        function S(t, n, a, u) {
          ...
          l ||
            ...
            (E.status = t),
            (E.statusText = (n || C) + ""),
            f ? m.resolveWith(h, [p, C, E]) : m.rejectWith(h, [E, C, v]),
            E.statusCode(x),
            (x = void 0),
  ...
  w.ajaxSetup({
    ...
    w.each(["top", "left"], function (e, t) {
      w.cssHooks[t] = $e(d.pixelPosition, function (e, n) {
        if (n)
          return (n = Ie(e, t)), Pe.test(n) ? w(e).position()[t] + "px" : n;
      });
    }),
  ...
  $(document).on("click", ".action-toggle-class", function () {
    action_toggle_class({
      target_id: $(this).data("target-id"),
      class_name: $(this).data("class-name"),
      body_class_name: $(this).data("body-class-name") || "",
    });
  }),
  $(document).on("submit", "#submit-subscribe", function () {
    var e = { submit_subscribe: "yes", email: $("#email").val() },
      t = { target_id: "email-field-status-loading", class_name: "active" },
      n = { target_id: "email-field-status-success", class_name: "active" };
    return (
      $("#email").val("Just one sec ..."),
      action_toggle_class({
        target_id: "email-field-status-ready",
        class_name: "active",
      }),
      action_toggle_class(t),
      $.ajax({
        type: "POST",
        data: e,
        encode: !0,
        success: function (e) {
          (response_data = JSON.parse(e)),
            "success" == response_data.response &&
              (console.log(response_data.message),
              setTimeout(function () {
                $("#email").val("You’re in!"),
                  action_toggle_class(t),
                  action_toggle_class(n);
              }, 1e3)),
